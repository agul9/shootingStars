...
void goToStart() {
    ...
    drawString(75, 60, "SHOOTING STARS", ((31) | (23)<<5 | (23)<<10));
    drawString(60, 70, "Press START to play", ((31) | (23)<<5 | (23)<<10));
...
void goToPause() {
    ...
    drawString((240-(6*6))/2, 80, "Paused", 0);
    state = PAUSE;
}

void goToWin() {
    fillScreen(((0) | (31)<<5 | (0)<<10));
    drawString((240-(7*6))/2, 80, "You Win!", 0);
    state = WIN;
}

void goToLose() {
    fillScreen(((31) | (0)<<5 | (0)<<10));
    drawString((240-(8*6))/2, 80, "You Lose!", 0);
    state = LOSE;
}

void drawStar(int col, int row) {
    drawLine(col, row + 4, 8, ((31) | (31)<<5 | (31)<<10));
    drawVLine(col + 4, row, 8, ((31) | (31)<<5 | (31)<<10));
    drawLeftDiagLine(col, row + 8, 8, ((31) | (31)<<5 | (31)<<10));
    drawRightDiagLine(col + (8 - 1), row + 8, 8, ((31) | (31)<<5 | (31)<<10));
}
